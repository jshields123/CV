...
| PipeFace                     | A facebook styled web app that was created with Ruby on Rails and consolidated the CRUD software architecture style. The app was continuously integrated with CI and deployed on Heroku. We used Trello to plan our tasks and sprints and GitHub to raise, track and resolve issues.      | Ruby, HTML, CSS, RSpec, Rails, Bootstrap  | [Pipeface](https://github.com/jshields123/acebook--Pipeface-)
